...
with open('Европа плюс (Ярославль)_12_11_2024_0300-2359.txt', 'r', encoding='utf-8') as file:
...
for block in blocks:
    ...
    print(f"Продолжительность блока: {block_duration}")

print(f"Общая продолжительность всех блоков: {total_duration}")